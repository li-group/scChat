...
_release_version: str = '0.4.26'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = 'fed7efd73003988282744b2f649df493b808c781'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.4.26'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = 'fed7efd73003988282744b2f649df493b808c781'"
