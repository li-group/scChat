"""
Cell type validation and discovery utilities.

This module contains validation functions moved from shared/cell_type_utils.py:
- LLM-based cell type extraction from questions
- Cell discovery logic for workflow planning
- Validation steps creation for processing pipelines

Functions moved from shared/cell_type_utils.py:
- extract_cell_types_from_question(): LLM + Neo4j cell type identification
- needs_cell_discovery(): Check if cell types need to be discovered
- create_cell_discovery_steps(): Generate discovery steps using hierarchy
"""
